...
\date{}
\subtitle={Medición de la relacion entre la constante de Planck y la carga del electron, $h/e$}
\email={}
		...
		\begin{center}
			...
			{\begin{tcolorbox}[colframe=white, colback=principaldos, arc=8pt]
				\begin{onecolabstract}
					...
					\noindent\textit{Palabras clave:} Efecto fotoeléctrico, LED, constante de Planck, carga del electron.
				\end{onecolabstract}
			\end{tcolorbox}}
