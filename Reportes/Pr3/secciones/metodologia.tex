...
por lo que la pendiente de la gráfica de $\nu$ en función de $V_{A-K}$ corresponde a $e/h$. En consecuencia, el inverso de dicha pendiente proporciona una estimación experimental de la razón $h/e$.Con el conjunto de datos obtenidos se construyó una gráfica de $\nu$ en función de $V_{A-K}$ y se realizó un ajuste lineal de la forma
