...
\date{}
\subtitle={Medición de la relacion entre la carga del electron y la constante de Boltzmann, $e/k_B$}
\email={}
		...
		\begin{center}
			...
			{\begin{tcolorbox}[colframe=white, colback=principaldos, arc=8pt]
				\begin{onecolabstract}
					...
					\noindent\textit{Palabras clave:} Ecuación de Shockley, Carga del electrón, Constante de Boltzman, Curva de Polarización, Diodo
				\end{onecolabstract}
			\end{tcolorbox}}
